        ...
        try {
            ...
            if (
                ...
                return jsonResponse(
                    {
                        error:
                            'Esta ejecución pertenece a otro técnico.'
                    },
                    403
                );
            ...
            if (
                ...
                return jsonResponse(
                    {
                        error:
                            'No fue posible obtener el audio.'
                    },
                    500
                );
            ...
            if (
                ...
                return jsonResponse(
                    {
                        error:
                            'El audio supera el límite permitido para transcripción.'
                    },
                    413
                );
            ...
            if (updateError) {
                ...
                return jsonResponse(
                    {
                        error:
                            'La transcripción se generó pero no pudo guardarse.'
                    },
                    500
                );
            ...
            return jsonResponse(
                {
                    error:
                        'Error interno de transcripción.'
                },
                500
            );
