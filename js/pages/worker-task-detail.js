...
} from '../services/executions.js?v=20260814-01';
...
function renderActionState() {
    ...
    if (
        ...
        text.textContent =
            'Confirmaste la tarea. Cuando estés listo para comenzar, iniciá el trabajo.';
    ...
    if (
        ...
        text.textContent =
            'La ejecución está abierta. Registrá el trabajo realizado antes de completarla.';
    ...
    if (
        ...
        text.textContent =
            'Tu participación ya fue finalizada. Debajo podés consultar el trabajo que registraste.';
...
acceptButton.addEventListener(
    ...
    async () => {
        ...
        const confirmed =
            window.confirm(
                '¿Confirmás que aceptás esta tarea?'
            );
...
startTaskButton.addEventListener(
    ...
    async () => {
        ...
        const confirmed =
            window.confirm(
                '¿Confirmás que comenzás a trabajar en esta tarea?'
            );
...
completeWorkButton.addEventListener(
    ...
    async () => {
        ...
        const confirmed =
            window.confirm(
                '¿Confirmás que finalizaste tu trabajo en esta tarea?'
            );
