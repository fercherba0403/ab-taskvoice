...
function showError(
    ...
    message.className =
        'technician-reports-message error';
...
function createActionCell(
    ...
    wrapper.className =
        'technician-report-actions-cell';
    ...
    if (
        ...
        taskLink.className =
            'technician-report-open secondary';

        taskLink.href =
            `./tarea-detalle.html?id=${row.task_id}`;
...
function detailSection(
    ...
    section.className =
        'technician-report-detail-section';
...
function openDetail(
    ...
    heading.className =
        'technician-report-detail-heading';
...
async function loadReport() {
    ...
    try {
        ...
        currentRows =
            await getTechnicianTeamOperationalReport(
                getFilters()
            );
        ...
        console.error(
            'Error cargando búsqueda operativa del equipo:',
            error
        );
        ...
        loading.textContent =
            'No fue posible cargar la búsqueda operativa.';
...
async function initialize() {
    ...
    try {
        ...
        console.error(
            'Error inicializando Reportes del Técnico:',
            error
        );
